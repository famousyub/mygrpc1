...
func (x *Messagesender) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
var file_messenger_proto_rawDesc = []byte{
	...
	,
...
var file_messenger_proto_goTypes = []interface{}{
	(*Messagesender)(nil), // 0: messenger.Messagesender
}
var file_messenger_proto_depIdxs = []int32{
	0, // 0: messenger.MessageService.SayHello:input_type -> messenger.Messagesender
	0, // 1: messenger.MessageService.SayHello:output_type -> messenger.Messagesender
...
type MessageServiceClient interface {
	SayHello(ctx context.Context, in *Messagesender, opts ...grpc.CallOption) (*Messagesender, error)
}
...
func (c *messageServiceClient) SayHello(ctx context.Context, in *Messagesender, opts ...grpc.CallOption) (*Messagesender, error) {
	out := new(Messagesender)
	err := c.cc.Invoke(ctx, "/messenger.MessageService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MessageServiceServer interface {
	SayHello(context.Context, *Messagesender) (*Messagesender, error)
}
...
func (*UnimplementedMessageServiceServer) SayHello(context.Context, *Messagesender) (*Messagesender, error) {
...
func _MessageService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/messenger.MessageService/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).SayHello(ctx, req.(*Messagesender))
	}
